...
kind: Deployment
metadata:
  name: {{ include "devops-knowledge-share-api.fullname" . }}-blue
  labels:
...
spec:
  ...
  selector:
    matchLabels:
      {{- include "devops-knowledge-share-api.selectorLabels" . | nindent 6 }}
      slot: blue
  template:
    metadata:
      labels:
        {{- include "devops-knowledge-share-api.labels" . | nindent 8 }}
        slot: blue
      annotations:
    ...
    spec:
      ...
      containers:
        - name: {{ .Chart.Name }}
          ...
          image: {{ include "devops-knowledge-share-api.container" $data }}
...
kind: Deployment
metadata:
  name: {{ include "devops-knowledge-share-api.fullname" . }}-green
  labels:
    {{- include "devops-knowledge-share-api.labels" . | nindent 4 }}
    slot: green
